...
const Navbar = ({ scrollClass }) => {
  ...
  return (
    <div
      className={`text-white flex px-4 py-3 lg:px-8 bg-themeBlack z-50 ${scrollClass} z-50`}
      data-aos="fade-down"
    >
      <NavLink to={"/"}>
      ...
      <div className="flex-1 items-end flex flex-col justify-center gap-y-5">
        <ul className="flex gap-3 md:gap-6">
          <span>
            <a
              href="https://www.facebook.com/cascadeeventsctg/"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div>
          <div className="dropdown dropdown-left lg:hidden">
            ...
            {dropdownOpen && (
              <ul
                className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-themeBlack rounded-box w-40
    h-max gap-2 z-50
    "
              >
                <NavLink to={"/about"}>
